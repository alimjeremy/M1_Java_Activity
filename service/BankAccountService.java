package com.bpi.m4.Activity9.service;

import com.bpi.m4.Activity9.exception.AccountNotFoundException;
import com.bpi.m4.Activity9.exception.InsufficientFundsException;
import com.bpi.m4.Activity9.exception.InvalidAccountException;
import com.bpi.m4.Activity9.exception.InvalidTransferException;
import com.bpi.m4.Activity9.model.BankAccount;
...
public class BankAccountService {
	...
	public void createAccount(String accountNumber, String ownerName, double initialBalance)
		...
		if (initialBalance < MINIMUM_INITIAL_BALANCE) {
			...
			throw new InvalidAccountException(String.format("Minimum Initial Balance: %.2f, Received Balance: %.2f",MINIMUM_INITIAL_BALANCE,initialBalance));
	...
	public void transfer(String fromAccountNumber, String toAccountNumber, double amount)
		...
		if (fromAccount.getBalance() < amount) {
			...
			throw new InsufficientFundsException(String.format("Balance %.2f, Required %.2f", +fromAccount.getBalance(), amount));
